...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588 4 4 0 0 0 7.049 3.082 4 4 0 0 0 5.42-1.435 4 4 0 0 0 .556-6.588 4 4 0 0 0-2.526-5.77A3 3 0 0 0 12 5Z" /><path d="M12 5a3 3 0 1 0 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588 4 4 0 0 1-7.049 3.082 4 4 0 0 1-5.42-1.435 4 4 0 0 1-.556-6.588 4 4 0 0 1 2.526-5.77A3 3 0 0 1 12 5Z" /><path d="M6 12a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" /><path d="M12 12a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" /><path d="M18 12a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" /><path d="M12 18a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" /></svg>
);
...
export const GitCommitHorizontalIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 12H3"/><path d="M14 12h7"/><circle cx="12" cy="12" r="2"/></svg>
);
...
export const SyringeIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m18 2 4 4"/><path d="m17 7 3-3"/><path d="M19 9 8.7 19.3c-1 1-2.5 1-3.4 0l-2.6-2.6c-1-1-1-2.5 0-3.4L15 1"/><path d="m9 11 4 4"/><path d="m5 19-3 3"/><path d="m12.4 3.4 1.2 1.2"/></svg>
);

export const MessageCircleHeartIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7.9 20A9 9 0 1 0 4 16.1l-3.5 2.9a.5.5 0 0 0 0 .8L4 20Z"/><path d="M10.1 9.4a.5.5 0 0 0-.8-1l-2.4 2.4A5.4 5.4 0 0 0 12 16.5a5.4 5.4 0 0 0 5.1-5.7l-2.4-2.4a.5.5 0 0 0-.8 1l1.8 1.8a2 2 0 0 1-2.7 2.7l-4-4Z"/></svg>
);
...
export const FolderOpenIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v2.5"/><path d="M20 19-2 19"/></svg>
);
...
export const TimelineIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 6h-6"/><path d="M22 12h-8"/><path d="M22 18h-10"/><path d="M4 6.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/><path d="M4 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/><path d="M4 18.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/></svg>
);
